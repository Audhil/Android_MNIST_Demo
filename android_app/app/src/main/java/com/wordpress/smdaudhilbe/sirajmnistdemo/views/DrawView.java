package com.wordpress.smdaudhilbe.sirajmnistdemo.views;
...
public class DrawView extends View {
    ...
    public float[] getPixelData() {
        ...
        System.out.println("ding! pixels.length : " + pixels.length);
        for (int i = 0; i < pixels.length; i++) {
            System.out.println(String.format("ding! %d is %d ", i, pixels[i]));
        }
        ...
        System.out.println("ding! retPixels.length : " + retPixels.length);
        for (int i = 0; i < retPixels.length; i++) {
            System.out.println(String.format("ding! %d is %f ", i, retPixels[i]));
        }
